...
const HeroSection = () => {
    return (
        <section className="pt-32 pb-16 relative bg-gradient-to-b from-cambridge-blue-900 via-cambridge-blue-800 to-cal-poly-green-600 overflow-hidden">
            {/* Background elements */}
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                >
                    <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
                        Get In <span className="text-mindaro-400">Touch</span>
                    </h1>
