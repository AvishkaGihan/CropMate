            ...
            <nav className="container mx-auto px-4 py-4 flex justify-between items-center">
                ...
                >
                    <div className="flex flex-col items-end gap-1.5">
                        <span
                            className={`block h-0.5 w-6 bg-mindaro-400 rounded transition-all duration-300 ${isMenuOpen ? "rotate-45 translate-y-2" : ""
                                }`}
                        />
                        <span
                            className={`block h-0.5 w-4 bg-mindaro-400 rounded transition-all duration-300 ${isMenuOpen ? "w-0 opacity-0" : ""
                                }`}
                        />
                        <span
                            className={`block h-0.5 w-6 bg-mindaro-400 rounded transition-all duration-300 ${isMenuOpen ? "-rotate-45 -translate-y-2" : ""
